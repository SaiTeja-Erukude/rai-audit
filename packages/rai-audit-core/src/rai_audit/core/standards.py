...
STANDARDS_REGISTRY: dict[str, str] = {
    ...
    # OWASP
    "OWASP-LLM-01": "OWASP LLM Top 10 #1 — Prompt Injection",
    "OWASP-LLM-02": "OWASP LLM Top 10 #2 — Insecure Output Handling",
    "OWASP-LLM-06": "OWASP LLM Top 10 #6 — Sensitive Information Disclosure",
